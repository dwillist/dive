...
require (
	...
	github.com/buildpacks/imgutil v0.0.0-20200814190540-04db0a9bb84f // indirect
...
replace github.com/buildpacks/pack => /Users/dan/workspace/VMware/buildpacks/pack
